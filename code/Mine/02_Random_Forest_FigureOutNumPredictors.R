...
# ========================================================
# Save results & Find the optimal number of predictors
# ========================================================

fit_predtest %>% readr::write_csv(file = file.path("results/Mine", "02_RandomForest_FigureOutNumPredictors.csv"))

# Automatically calculate the optimal number of predictors (Minimum MSE)
...
print("The mathematical optimal number of predictors for each metric is:")
print(npred_final)
...
ggplot(fit_predtest, aes(x = n, y = OOBr2)) + 
  ...
  theme_bw() +
  ggsave(file.path("figures_manuscript", "RandomForest_R2vNumberPredictors.png"),
         width = 150, height = 150, units = "mm")